...
interface LShareRewardPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lSharePerSecond()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lSharePerSecond",
    values?: undefined
  ): string;
...
export class LShareRewardPool extends BaseContract {
  ...
  interface: LShareRewardPoolInterface;
  ...
  functions: {
    ...
    lSharePerSecond(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    lSharePerSecond(overrides?: CallOverrides): Promise<PopulatedTransaction>;
