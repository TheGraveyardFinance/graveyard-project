...
interface LibraDummyInterface extends ethers.utils.Interface {
  functions: {
    "INITIAL_AIRDROP_WALLET_DISTRIBUTION()": FunctionFragment;
    "INITIAL_GENESIS_POOL_DISTRIBUTION()": FunctionFragment;
    "INITIAL_LIBRA_POOL_DISTRIBUTION()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "INITIAL_LIBRA_POOL_DISTRIBUTION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class LibraDummy extends BaseContract {
  ...
  functions: {
    ...
    INITIAL_LIBRA_POOL_DISTRIBUTION(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
