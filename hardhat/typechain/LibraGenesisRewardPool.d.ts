...
interface LibraGenesisRewardPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "libraPerSecond()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "libraPerSecond",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class LibraGenesisRewardPool extends BaseContract {
  ...
  interface: LibraGenesisRewardPoolInterface;
  ...
  functions: {
    ...
    libraPerSecond(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    libraPerSecond(overrides?: CallOverrides): Promise<PopulatedTransaction>;
