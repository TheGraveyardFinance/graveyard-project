...
import "@graveyardx/hardhat-etherscan";
...
const ftmScanToken: string = "AH4BWQJGVP3KC47UC8ZVRR63UIAUZJSPZB";
...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    ...
    apiKey: {
      fantom: ftmScanToken, // ftmscan
    }
    // apiKey: ETHERSCAN_TOKEN, // ETHERSCAN_TOKEN,
    // apiKey: {
    //   astar: "your API key",
    //   opera: "AH4BWQJGVP3KC47UC8ZVRR63UIAUZJSPZB",
    // },
  },
  gasReporter: {
  ...
  solidity: {
    ...
    overrides: {
      "contracts/distribution/XShareRewardPool.sol": {
        version: "0.6.12",
        settings: {
          optimizer: {
            enabled: true,
