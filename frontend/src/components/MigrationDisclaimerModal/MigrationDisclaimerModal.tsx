...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({ onConfirm, onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Mausoleum functionalities other than [Settle and withdraw] has been disabled for users
          who staked in legacy Mausoleum. Please withdraw all balances from the previous masonry after the update.
        </StyledText>
      </div>
      <ModalActions>
