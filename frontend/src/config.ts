...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      COUSD: ['0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18],
      ...
      '2OMB-COUSD LP': ['0xbdC7DFb7B88183e87f003ca6B5a2F81202343478',18],
      '2SHARES-COUSD LP': ['0x6398ACBBAB2561553a9e458Ab67dCFbD58944e52',18],
      '2SHARES': ['0xc54A1684fD1bef1f077a336E6be4Bd9a3096a6Ca', 18],
      'xGRAVE-COUSD LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae',18],
      'xSHARES-COUSD LP': ['0xd352daC95a91AfeFb112DBBB3463ccfA5EC15b65',18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  Xgrave2sharesWftmLPRewardPool: {
    name: 'Earn xGRAVE by staking 2SHARES-COUSD LP',
    poolId: 1,
    sectionInUI: 0,
  ...
  Xgrave2ombWftmLPRewardPool: {
    name: 'Earn xGRAVE by staking 2OMB-COUSD LP',
    poolId: 2,
    sectionInUI: 0,
    contract: 'Xgrave2ombWftmLPRewardPool',
    depositTokenName: '2OMB-COUSD LP',
    earnTokenName: 'xGRAVE',
    finished: false,
    multiplier: '6000x',
    site: "https://2omb.finance",
  ...
  XgraveWrappedFtmRewardPool: {
    name: 'Earn xGRAVE by staking COUSD',
    poolId: 6,
    sectionInUI: 0,
  ...
  XgraveFtmLPTShareRewardPool: {
    name: 'Earn xSHARES by xGRAVE-COUSD LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  TwoshareFtmLPTShareRewardPool: {
    name: 'Earn xSHARES by 2SHARES-COUSD LP',
    poolId: 2,
    sectionInUI: 2,
  ...
  TwoombFtmLPTShareRewardPool: {
    name: 'Earn xSHARES by 2OMB-COUSD LP',
    poolId: 3,
    sectionInUI: 2,
  ...
  Xgrave2SHARESFTMRebates: {
    name: 'Bond 2SHARES-COUSD LP, earn xGRAVE',
    poolId: 2,
    sectionInUI: 3,
    contract: 'XgraveFtmRewardPool',
    depositTokenName: '2SHARES-COUSD LP',
  ...
  //   name: 'Bond xGRAVE-COUSD LP, earn xGRAVE',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'XgraveFtmRewardPool',
  //   depositTokenName: 'xGRAVE-COUSD LP',
  ...
  //XgravexSHARESFTMRebates: {
   // name: 'Bond xSHARES-COUSD LP, earn xGRAVE',
   // poolId: 5,
   // sectionInUI: 3,
  //  contract: 'XgraveFtmRewardPool',
  //  depositTokenName: 'xSHARES-COUSD LP',
