...
const GraveNode = () => {
  ...
  const setTierValues = async () => {
    await graveyardFinance.getTierValues(bank.contract);
  }
      ...
      <Box>
        <Alert variant="filled" severity="info">
          ...
          <a
            style={{ color: '#fff' }}
            target={'_blank'}
            href="https://krynetix.gitbook.io/graveyard-finance/benefits-of-lp-nodes"
          >
            Node Docs & Strategy
          </a>{' '}
          in order to fully understand how our node pools work before purchasing, by partaking you accept the risks
          outlined in the docs & disclaimer. Sticking to the current strategy helps support the protocol which in turn
          helps you to continue to earn rewards!
        </Alert>
