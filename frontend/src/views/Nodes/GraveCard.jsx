...
import {GRAVE_NODE_MULTIPLIER} from '../../utils/constants';

const GraveCard = ({}) => {
  const tombBank = useBank('GraveNode');
            ...
            <Grid item sm={9}>
              <Grid container direction="column">
                <Grid item>
                  ...
                  <Typography color="textSecondary">Lock your Graves to earn daily yields</Typography>
                </Grid>
                <Grid item>
          ...
          <Grid container direction="column" spacing={1}>
            ...
            <Grid item>
              <Grid container justifyContent="space-between">
                ...
                <Grid item>
                  <b className="card-info-value">{GRAVE_NODE_MULTIPLIER} ticket per Node</b>
                </Grid>
              </Grid>
            </Grid>
            <Grid item>
