...
const assetList = [
    ...
    "0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae", // xGRAVE/wftm
...
function useRebateTreasury() {
    ...
    const [ xgravePrice, setXgravePrice ] = useState(0)
    const [ xgraveAvailable, setXgraveAvailable ] = useState(0)
    ...
    async function update() {
        const [
            ...
            RebateTreasury.methods.getXgravePrice().call(),
        ...
        setXgravePrice(+web3.utils.fromWei(xgravePrice))
        setXgraveAvailable(+web3.utils.fromWei(xgraveBalance) - +web3.utils.fromWei(vestedXgrave))
