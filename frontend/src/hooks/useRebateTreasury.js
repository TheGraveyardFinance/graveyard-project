...
function useRebateTreasury() {
    ...
    const [ gravePrice, setXgravePrice ] = useState(0)
    const [ graveAvailable, setXgraveAvailable ] = useState(0)
    ...
    async function update() {
        ...
        setXgravePrice(+web3.utils.fromWei(gravePrice))
        setXgraveAvailable(+web3.utils.fromWei(graveBalance) - +web3.utils.fromWei(vestedXgrave))
