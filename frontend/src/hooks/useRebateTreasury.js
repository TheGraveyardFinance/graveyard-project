...
const Threeomb = new web3.eth.Contract(ERC20ABI, "0x56C68a33e6F20aBC6Bcb46695f1811fE5cbF92Fe")
...
function useRebateTreasury() {
    ...
    const [ gravePrice, setGravePrice ] = useState(0)
    const [ graveAvailable, setGraveAvailable ] = useState(0)
    ...
    async function update() {
        const [
            ...
            RebateTreasury.methods.getGravePrice().call(),
        ...
        setGravePrice(+web3.utils.fromWei(gravePrice))
        setGraveAvailable(+web3.utils.fromWei(graveBalance) - +web3.utils.fromWei(vestedGrave))
